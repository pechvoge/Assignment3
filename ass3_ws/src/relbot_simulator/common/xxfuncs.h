...
/* XXDelay is model specific and therefore implemented in Plant.cpp */
/* XXInitialValue is model specific and therefore implemented in Plant.cpp */
...
/* XXStopSimulation is implemented in Plant.cpp */
