...
2. To change the velocity sequence run the following in a new terminal(on the dots either "constant_velocity", "sinusoidal_velocity", "sequence_velocity" or "custom_velocity"):
...
Parameters
    ...
    std::string velocity_test_: Velocity test sequences. Default = "constant_velocity", other options: "sinusoidal_velocity", "sequence_velocity", "custom_velocity"
...
Core Components(Modified)
    ...
    custom_velocity(): Publishes a velocity sequence: drive straight and make a 90deg turn
